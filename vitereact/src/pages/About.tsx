  ...
  return (
    <main className="bg-forest min-h-screen text-ivory">
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 max-w-7xl mx-auto">
        <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-9xl font-display text-gold mb-8 sm:mb-10 md:mb-12 uppercase drop-shadow-lg">
          Our Story
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-start">
          <div className="space-y-4 sm:space-y-6 font-body text-base sm:text-lg leading-relaxed text-ivory/90">
            <p className="text-xl sm:text-2xl font-display text-gold mb-3 sm:mb-4">
          ...
          <div className="space-y-4 sm:space-y-6 font-body text-base sm:text-lg leading-relaxed text-ivory/90 bg-forest/50 p-6 sm:p-8 border border-gold/20 rounded-lg">
            <p>
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li className="flex flex-col sm:flex-row sm:gap-4">
                <span className="text-gold font-display text-lg sm:text-xl mb-1 sm:mb-0 sm:whitespace-nowrap">Restaurants</span>
                <span>need content that brings local consumers to their front door.</span>
              </li>
              <li className="flex flex-col sm:flex-row sm:gap-4">
                <span className="text-gold font-display text-lg sm:text-xl mb-1 sm:mb-0 sm:whitespace-nowrap">E-commerce</span>
                <span>businesses need global exposure to be seen above the crowd.</span>
              </li>
              <li className="flex flex-col sm:flex-row sm:gap-4">
                <span className="text-gold font-display text-lg sm:text-xl mb-1 sm:mb-0 sm:whitespace-nowrap">Coaches</span>
                <span>and educators need personal branding in order to build trust.</span>
              </li>
              <li className="flex flex-col sm:flex-row sm:gap-4">
                <span className="text-gold font-display text-lg sm:text-xl mb-1 sm:mb-0 sm:whitespace-nowrap">Service Pros</span>
                <span>need credibility and consistency to gain clients.</span>
              </li>
            </ul>
            <p className="pt-3 sm:pt-4 italic text-gold/80">
            ...
            <p className="text-xl sm:text-2xl font-display text-gold pt-3 sm:pt-4">
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 bg-ivory text-forest">
        <div className="max-w-7xl mx-auto space-y-16 sm:space-y-20 md:space-y-24">
          
          {/* Research */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
             <div>
                <h2 className="text-4xl sm:text-5xl md:text-6xl font-display text-forest mb-4 sm:mb-6 uppercase">Research</h2>
                <h3 className="text-xl sm:text-2xl font-display text-gold mb-3 sm:mb-4">Why & What do we research?</h3>
             ...
             <div className="bg-forest p-8 sm:p-10 md:p-12 rounded-lg transform rotate-2 shadow-xl border-4 border-gold">
                <div className="text-7xl sm:text-8xl md:text-9xl text-gold/20 font-display text-center">01</div>
             </div>
          </div>

          {/* Script */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
             <div className="order-2 md:order-1 bg-forest p-8 sm:p-10 md:p-12 rounded-lg transform -rotate-2 shadow-xl border-4 border-gold">
                <div className="text-7xl sm:text-8xl md:text-9xl text-gold/20 font-display text-center">02</div>
             </div>
             <div className="order-1 md:order-2">
                <h2 className="text-4xl sm:text-5xl md:text-6xl font-display text-forest mb-4 sm:mb-6 uppercase">Script</h2>
                <h3 className="text-xl sm:text-2xl font-display text-gold mb-3 sm:mb-4">Why & What is that we script?</h3>
                <div className="space-y-3 sm:space-y-4 font-body text-base sm:text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
             <div>
                <h2 className="text-4xl sm:text-5xl md:text-6xl font-display text-forest mb-4 sm:mb-6 uppercase">Film & Edit</h2>
                <h3 className="text-xl sm:text-2xl font-display text-gold mb-3 sm:mb-4">What & Why do you film & we Edit?</h3>
                <div className="space-y-3 sm:space-y-4 font-body text-base sm:text-lg">
             ...
             <div className="bg-forest p-8 sm:p-10 md:p-12 rounded-lg transform rotate-2 shadow-xl border-4 border-gold">
                <div className="text-7xl sm:text-8xl md:text-9xl text-gold/20 font-display text-center">03</div>
             </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
             <div className="order-2 md:order-1 bg-forest p-8 sm:p-10 md:p-12 rounded-lg transform -rotate-2 shadow-xl border-4 border-gold">
                <div className="text-7xl sm:text-8xl md:text-9xl text-gold/20 font-display text-center">04</div>
             </div>
             <div className="order-1 md:order-2">
                <h2 className="text-4xl sm:text-5xl md:text-6xl font-display text-forest mb-4 sm:mb-6 uppercase">Upload</h2>
                <h3 className="text-xl sm:text-2xl font-display text-gold mb-3 sm:mb-4">Why do we Upload?</h3>
                <div className="space-y-3 sm:space-y-4 font-body text-base sm:text-lg">
                ...
                <div className="mt-6 sm:mt-8">
                  <a 
                    ...
                    className="inline-block bg-rust text-ivory font-display text-xl sm:text-2xl px-8 sm:px-12 py-3 sm:py-4 rounded shadow-lg hover:bg-red-700 transition-all uppercase tracking-wide transform hover:scale-105"
                  >
                    Book Now
                  </a>
                </div>
